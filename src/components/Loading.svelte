<svg
  ...
  style="margin:auto;background:#fff0;display:block;width:72px"
  width="200px"
  height="100px"
  viewBox="0 0 100 100"
...
>
  <g transform="translate(0 18)">
    ...
    <defs>
      ...
      <clipPath id="ldio-8w02qnenzff-cp"
        ><use xlink:href="#ldio-8w02qnenzff-path" /></clipPath
      >
    </defs>
    <g clip-path="url(ldio-8w02qnenzff-cp)">
      <path
        fill="#bbbbbb"
